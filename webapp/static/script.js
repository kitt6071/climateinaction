...
window.AppFunctions = {
    ...
    performNetworkAnalysis: window.performNetworkAnalysis || (() => console.log('performNetworkAnalysis not yet loaded')),
    performIndirectImpactsAnalysis: window.performIndirectImpactsAnalysis || (() => console.log('performIndirectImpactsAnalysis not yet loaded')),
    executeKnowledgeGraphQuery: window.executeKnowledgeGraphQuery || (() => console.log('executeKnowledgeGraphQuery not yet loaded')),
    toggleChainMode,
    displayTriplets,
    performSearch,
    initializeTabs
